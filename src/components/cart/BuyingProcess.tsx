...
const BuyingProcess = () => {
    ...
    return (
        <>
            ...
            <div className="modal">
                <div className="modal-box flex flex-col h-[50%] overflow-visible relative min-w-[300px] max-w-[500px]  min-h-[300px] max-h-[500px] w-11/12">
                        ...
                        <div className="flex items-center justify-evenly flex-col w-full h-full">
                            ...
                            {currentStep === "Order" &&
                                ...
                                >
                                    ...
                                    <div className="flex flex-col overflow-y-auto max-h-52 h-full w-full items-center">
