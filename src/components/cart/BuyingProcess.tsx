...
const BuyingProcess = () => {
    ...
    return (
        <>
            ...
            <div className="modal">
                <div className="modal-box flex flex-col justify-between min-h-[50vh] overflow-visible relative min-w-[300px] max-w-[500px] w-11/12">
                        ...
                        <div className="flex items-center justify-evenly flex-col w-full">
                            ...
                            {currentStep === "Order" &&
                                <form
                                    ...
                                    id="shipping-info"
                                    className="flex h-full items-center flex-col w-full gap-4"
                                >
                                    <h1 className="w-2/3 my-3 text-center font-medium text-md"> Rellene el formulario con la información de envío para completar su pedido 😊 </h1>
                                    <button onClick={() => {
                                        console.log("WhatsApp")
                                    }} className="btn btn-sm btn-primary absolute bottom-8 left-8 border-none gap-2">
                                    ...
                                    <div className="flex flex-col flex-wrap h-full w-full items-center justify-evenly">
                                        <div className="max-w-[240px] flex flex-col">
                                            ...
                                            <textarea placeholder="Dirección"
                                                ...
                                                className="input input-primary !bg-[hsl(var(--b1)/var(--tw-bg-opacity))]"></textarea>
                                            {errors.address ? (
