...
// make a regex for an eigh cifer phone number that starts with 5
...
const BuyingProcess = () => {
    ...
    const handleFinish = () => {
        console.log("submit-handleFinish")
        return
    }

    const onSubmit: SubmitHandler<FormValues> = (data) => {
        console.log("submit-onSubmit", data)
        return
    }
    ...
    return (
        <>
            ...
            <div className="modal">
                <div className="modal-box relative min-w-[300px] w-11/12 max-w-5xl">
                    <div className="flex flex-col justify-between items-center">
                        <div className="flex flex-row gap-4">

                            <ul className="steps steps-horizontal max-[400px]:scale-90 ">
                                <li className="step step-primary">Sesión</li>
                                <li className={`step ${steps.indexOf(currentStep) >= steps.indexOf("Order") ? "step-primary" : ""}`}>Pedido</li>
                                <li className={`step ${steps.indexOf(currentStep) >= steps.indexOf("Confirm") ? "step-primary" : ""}`}>Recibo</li>
                            </ul>
                            <label
                                htmlFor="buy-modal"
                                ...
                                <form
                                    ...
                                    <div className="flex flex-wrap w-full justify-evenly">
                                        <div className="max-w-[140px] flex flex-col">
                                            ...
                                            />
                                            {errors.address ? (
                                                <div data-tip="Debe ser un número de 8 cifras que comience con 5" className="badge-warning badge tooltip tooltip-warning tooltip-bottom my-[2px] gap-2">
                                                    <svg
                                                        fill="none"
                                                        viewBox="0 0 24 24"
                    ...
                    <div className="modal-action w-full">
                        ...
                        <button
                            ...
                            }} className={`btn ${currentStep === steps[0] ? "btn-disabled" : "btn-secondary"}`}>{currentStep === "Confirm" ? "Completar" : "Siguiente"}</button>
                    </div>
                </div>
            </div>
        </>
